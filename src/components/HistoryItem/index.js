...
const HistoryItem=props=>{
    ...
    const onRemoveHistory=()=>{
        ...
        return(
            ...
            <img src={logoUrl} alt='domain logo' className="history-domain-logo"/>
            ...
            <button className="history-del-btn" type="button" onClick={onRemoveHistory} data-testid="delete">
            <img src="https://assets.ccbp.in/frontend/react-js/delete-img.png" className="history-del-icon" alt="delete"/>
            </button>
            </li>
